...
//            }
//        });
//        ArrayAdapter fromAdapter = new ArrayAdapter(this, R.layout.translate_spinner_item, fromLanguage);
...
//            }
//        });
//        ArrayAdapter toAdapter = new ArrayAdapter(this, R.layout.translate_spinner_item, toLanguage);
//
...
//            @Override
//            public void onFailure(@NonNull Exception e) {
//                Toast.makeText(Translate.this, "Failed to download model!! Check your internet connection.", Toast.LENGTH_SHORT).show();
//            }
//        });
//    }
//    @Override
